 ...
 * @param <K>
 */
public class PriorityQueueOriginal<K> implements Iterable<K> {
     ...
     */
    public PriorityQueueOriginal(boolean max, Object[] binHeap, int first, int last, Comparator<K> comparator, boolean floyd) {
        this.max = max;
        this.first = first;
     ...
     * @param comparator a comparator for the type K
     */
    public PriorityQueueOriginal(int n, int first, boolean max, Comparator<K> comparator, boolean floyd) {
     ...
     * @param comparator a comparator for the type K
     */
    public PriorityQueueOriginal(int n, boolean max, Comparator<K> comparator, boolean floyd) {
     ...
     * @param comparator a comparator for the type K
     */
    public PriorityQueueOriginal(int n, boolean max, Comparator<K> comparator) {
     ...
     * @param comparator a comparator for the type K
     */
    public PriorityQueueOriginal(int n, Comparator<K> comparator) {
    ...
    static void doMain() {
        ...
        boolean max = true;
        boolean floyd = true;
        Iterable<String> PQ_string_floyd = new PriorityQueueOriginal<>(max, s1, 1, 5, Comparator.comparing(String::toString), floyd);
        Iterable<String> PQ_string_nofloyd = new PriorityQueueOriginal<>(max, s1, 1, 5, Comparator.comparing(String::toString), false);
        Integer[] s2 = new Integer[5]; //created an Integer type array with size 5
        for (int i = 0; i < 5; i++) {
            s2[i] = i;
        }
        Iterable<Integer> PQ_int_floyd = new PriorityQueueOriginal<>(max, s2, 1, 5, Comparator.comparing(Integer::intValue), floyd);
        Iterable<Integer> PQ_int_nofloyd = new PriorityQueueOriginal<>(max, s2, 1, 5, Comparator.comparing(Integer::intValue), false);
    }
}